## 🛡️ Policy Deployment Engine: `dataplex_asset_iam`

This section provides a concise policy evaluation for the `dataplex_asset_iam` resource in GCP.

Reference: [Terraform Registry – dataplex_asset_iam](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/dataplex_asset_iam)
...
| `lake` |  | false | false | None | None | None |
| `dataplex_zone` |  | false | false | None | None | None |
| `asset` |  | false | false | None | None | None |
...
| `role` | `google_dataplex_asset_iam_binding` can be used per role. Note that custom roles must be of the format `[projects|organizations]/{parent-name}/roles/{role-name}`. | false | false | None | None | None |
